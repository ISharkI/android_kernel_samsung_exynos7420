#undef TRACE_SYSTEM
#define TRACE_SYSTEM cpufreq_intergalactic

#if !defined(_TRACE_CPUFREQ_INTERGALACTIC_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_CPUFREQ_INTERGALACTIC_H
...
DEFINE_EVENT(set, cpufreq_intergalactic_setspeed,
	TP_PROTO(u32 cpu_id, unsigned long targfreq,
	     unsigned long actualfreq),
	TP_ARGS(cpu_id, targfreq, actualfreq)
);
...
DEFINE_EVENT(set, cpufreq_intergalactic_cpu_min_qos,
	TP_PROTO(u32 cpu_id, unsigned long targfreq,
	     unsigned long actualfreq),
	TP_ARGS(cpu_id, targfreq, actualfreq)
);

DEFINE_EVENT(set, cpufreq_intergalactic_cpu_max_qos,
	TP_PROTO(u32 cpu_id, unsigned long targfreq,
	     unsigned long actualfreq),
	TP_ARGS(cpu_id, targfreq, actualfreq)
);
#ifdef CONFIG_ARM_EXYNOS_MP_CPUFREQ
DEFINE_EVENT(set, cpufreq_intergalactic_kfc_min_qos,
	TP_PROTO(u32 cpu_id, unsigned long targfreq,
	     unsigned long actualfreq),
	TP_ARGS(cpu_id, targfreq, actualfreq)
);

DEFINE_EVENT(set, cpufreq_intergalactic_kfc_max_qos,
	TP_PROTO(u32 cpu_id, unsigned long targfreq,
	     unsigned long actualfreq),
	TP_ARGS(cpu_id, targfreq, actualfreq)
);
...
DEFINE_EVENT(loadeval, cpufreq_intergalactic_target,
	    TP_PROTO(unsigned long cpu_id, unsigned long load,
		     unsigned long curtarg, unsigned long curactual,
		     unsigned long newtarg),
	    TP_ARGS(cpu_id, load, curtarg, curactual, newtarg)
...
DEFINE_EVENT(loadeval, cpufreq_intergalactic_already,
	    TP_PROTO(unsigned long cpu_id, unsigned long load,
		     unsigned long curtarg, unsigned long curactual,
		     unsigned long newtarg),
	    TP_ARGS(cpu_id, load, curtarg, curactual, newtarg)
...
DEFINE_EVENT(loadeval, cpufreq_intergalactic_notyet,
	    TP_PROTO(unsigned long cpu_id, unsigned long load,
		     unsigned long curtarg, unsigned long curactual,
		     unsigned long newtarg),
	    TP_ARGS(cpu_id, load, curtarg, curactual, newtarg)
...
DEFINE_EVENT(modeeval, cpufreq_intergalactic_mode,
	    TP_PROTO(unsigned long cpu_id, unsigned long total_load,
		     unsigned long single_enter, unsigned long multi_enter,
		     unsigned long single_exit, unsigned long multi_exit, unsigned long mode),
	    TP_ARGS(cpu_id, total_load, single_enter, multi_enter, single_exit, multi_exit, mode)
...
#endif
TRACE_EVENT(cpufreq_intergalactic_boost,
...
TRACE_EVENT(cpufreq_intergalactic_unboost,
	    TP_PROTO(const char *s),
	    TP_ARGS(s),
	    TP_STRUCT__entry(
		    __string(s, s)
...
#endif /* _TRACE_CPUFREQ_INTERGALACTIC_H */
